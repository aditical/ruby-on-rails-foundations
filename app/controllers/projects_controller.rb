class ProjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project.save
        format.html { redirect_to project_url(@project), notice: "Congratulations!! A new project is created." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to projects_url, notice: "The project is deleted sucessfully." }
